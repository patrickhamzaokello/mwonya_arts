            ...
            <div className="flex">
                ...
                <div className="w-1/3 pr-4">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <RevenueCard />
                        <MetricCard icon={Users} label="Followers" value="10.5K" />
                        <MetricCard icon={Disc} label="Releases" value="24" />
                        <MetricCard icon={DollarSign} label="Last Month" value="250K" />
                        <MetricCard icon={Briefcase} label="Projects" value="7" />
                    </div>
                </div>
