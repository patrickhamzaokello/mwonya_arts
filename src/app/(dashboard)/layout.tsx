  ...
  return (
    <ArtistProvider>
      <div className="h-screen flex">
        {/* Left Sidebar */}
        <div className="w-[14%] md:w-[8%] lg:w-[16%] xl:w-[14%] h-screen p-4 fixed top-0 left-0 overflow-y-auto bg-[#000] z-10">
        ...
        {/* Right Section */}
        <div className="ml-[14%] md:ml-[8%] lg:ml-[16%] xl:ml-[14%] w-[86%] md:w-[92%] lg:w-[84%] xl:w-[86%] h-screen flex flex-col bg-[#000]">
          {/* Top Navbar */}
