      ...
      <main className="flex-grow pt-16">
        <section className="relative py-32 px-4 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <div className="absolute inset-0 bg-gradient-to-r from-purple-900 via-blue-900 to-green-900 animate-gradient-x"></div>
          </div>
        ...
        <section id="features" className="py-20 px-4 bg-[#272727]">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">Advanced analytics and promotional tools to expand your fanbase.</p>
            </div>
            <div className="text-center">
        ...
        <section id="testimonials" className="py-20 px-4 bg-[#1a1a1a] overflow-hidden">
          ...
          <div className="relative">
            <div className="flex animate-scroll">
              {[
                { name: "Alex Rivera", role: "Indie Artist", quote: "Mwonya helped me gain 100K new listeners in just 3 months. The global reach is unreal!" },
                { name: "Sarah Chen", role: "Electronic Producer", quote: "The analytics tools are a game-changer. I can now tailor my music to what my fans love." },
                { name: "Marcus Johnson", role: "Hip-Hop Artist", quote: "From unknown to chart-topping in a year. Mwonya made it possible." },
                { name: "Marcus Johnson", role: "Hip-Hop Artist", quote: "From unknown to chart-topping in a year. Mwonya made it possible." },
                { name: "Marcus Johnson", role: "Hip-Hop Artist", quote: "From unknown to chart-topping in a year. Mwonya made it possible." },
                { name: "Marcus Johnson", role: "Hip-Hop Artist", quote: "From unknown to chart-topping in a year. Mwonya made it possible." },
                { name: "Lena Rodriguez", role: "Singer-Songwriter", quote: "The seamless distribution across platforms saved me countless hours. More time for creating!" },
                { name: "David Kim", role: "Classical Composer", quote: "I was skeptical about digital platforms, but Mwonya opened up a whole new audience for my compositions." },
                { name: "Emma Thompson", role: "Pop Artist", quote: "The support from the Mwonya team is incredible. They truly care about artists' success." }
              ].map((testimonial, index) => (
                <Card key={index} className="flex-shrink-0 w-80 mx-4 border-color: rgb(31 41 55); bg-neutral-900 text-gray-200">
                  <CardContent className="p-6">
                    <blockquote className="text-sm mb-4 font-light">"{testimonial.quote}"</blockquote>
